...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx7dcd098f9af0a15a',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '7a60034d26beaff718485b0a70a20f0e',
   ...
   */
  USERS: [oATmO6QLyq-pFrZB3HJGn-SERCTk
    {
      // 想要发送的人的名字
      name: 'ww',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oATmO6QLyq-pFrZB3HJGn-SERCTk',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'q0UIYhTIqT1wt9Ck6PM7Ax8lIx0TRrkMZx_c2p2HFqk',
      // 所在省份
      province: '湖南',
      // 所在城市
      city: '长沙',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '2001', date: '09-25',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'q0UIYhTIqT1wt9Ck6PM7Ax8lIx0TRrkMZx_c2p2HFqk',
